...
function renderClients(data) {
  ...
  data.forEach(function (c, i) {
    ...
    html += '<tr id="client-row-' + i + '">'
      ...
      +     '<button onclick="saveClientAliasInline(' + i + ')" style="margin-left:4px;padding:4px 10px;background:var(--primary);color:#fff;border:none;border-radius:6px;cursor:pointer;font-size:12px;font-weight:600">Valider</button>'
      +     '<button onclick="cancelClientAliasEdit(' + i + ')" style="margin-left:4px;padding:4px 8px;background:none;border:1px solid var(--border);border-radius:6px;cursor:pointer;font-size:12px;color:var(--text-2)">Annuler</button>'
      +   '</span>'
