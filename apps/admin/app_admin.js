...
function renderClients(data) {
  ...
  data.forEach(function (c, i) {
    ...
    html += '<tr id="client-row-' + i + '">'
      ...
      +     '<button onclick="saveClientAliasInline(' + i + ')" style="margin-left:4px;padding:4px 10px;background:#22c55e;color:#fff;border:none;border-radius:6px;cursor:pointer;font-size:12px;font-weight:600">Valider</button>'
      +     '<button onclick="cancelClientAliasEdit(' + i + ')" style="margin-left:4px;padding:4px 8px;background:#ef4444;color:#fff;border:none;border-radius:6px;cursor:pointer;font-size:12px;font-weight:600">Annuler</button>'
      +   '</span>'
